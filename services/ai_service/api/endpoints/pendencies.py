    ...
    try:
        with engine.begin() as connection:
            ...
            prompt_template = ChatPromptTemplate.from_messages([
                ("system", "Você é um especialista em organização de base de conhecimento. Sua tarefa é analisar a pergunta de um usuário e estruturá-la para um novo registro.\n{format_instructions}"),
                ("human", """**Regras Mandatórias:**
                1.  **Título:** Crie um título curto e direto (máximo 5 palavras) que resuma a pergunta.
            ...
            connection.execute(text("""
                INSERT INTO assuntos_pendentes (consulta_id, texto_assunto, status, datahora_sugestao, subcategoria_id, "createdAt", "updatedAt") 
                VALUES (:consulta_id, :titulo, 'pendente', :data, :sub_id, :now, :now)
            """), {
