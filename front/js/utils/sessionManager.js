...
export async function logoutUser(alertMessage = null) {
    ...
    try {
        // Tenta invalidar a sessão no backend (é seguro falhar se o token já for inválido).
...
// As funções de timeout permanecem as mesmas
...
export function startSessionManagement() {
    ...
    if (!localStorage.getItem('authToken')) {
        ...
        // Isso evita o alerta "Acesso negado" que poderia ser irritante.
        window.location.href = '../index.html';
        return;
    }
