// Importa o serviço de API que criamos
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- O código de timeout e sessão foi REMOVIDO daqui ---
    // --- Ele deve permanecer apenas nas páginas internas do dashboard ---
    ...
    // Validação real: se não houver token, a página é inútil.
    if (!token) {
